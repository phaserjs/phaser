var ShaderPipeline = function(gl, program, vertexShader, fragmentShader) 
{
    this.context = gl;
...
ShaderPipeline.prototype.constructor = ShaderPipeline;

/* For WebGL2 this won't be necessary */
ShaderPipeline.prototype = {
