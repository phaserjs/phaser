...
var WebGLBlendParametersFactory = {
     ...
     *
     * @method Phaser.Renderer.WebGL.WebGLBlendParameters#createCombined
     * @param {Phaser.Renderers.WebGL.WebGLRenderer} renderer - The WebGLRenderer to create the WebGLBlendParameters for.
     * @param {GLboolean} [enabled=true] - Whether blending is enabled.
     * @param {GLclampf[4]} [color=[0, 0, 0, 0]] - The blend color (array of 4 channels, 0-1).
     ...
     * Where `equation`, `funcSrc`, and `funcDst` are the same for RGB and alpha.
     *
     * @method Phaser.Renderer.WebGL.WebGLBlendParameters#createSeparate
     * @param {Phaser.Renderers.WebGL.WebGLRenderer} renderer - The WebGLRenderer to create the WebGLBlendParameters for.
     * @param {GLboolean} [enabled=true] - Whether blending is enabled.
     * @param {GLclampf[4]} [color=[0, 0, 0, 0]] - The blend color (array of 4 channels, 0-1).
