 ...
 *
 * @method Phaser.Loader.LoaderPlugin#listeners
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Loader.LoaderPluginEventsMap} K - [event]
 *
 ...
 *
 * @method Phaser.Loader.LoaderPlugin#listenerCount
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Loader.LoaderPluginEventsMap} K - [event]
 *
 ...
 *
 * @method Phaser.Loader.LoaderPlugin#emit
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Loader.LoaderPluginEventsMap} K - [event]
 * @genericUse {Phaser.Types.Events.EmitArguments<Phaser.Types.Loader.LoaderPluginEventsMap[K]>} - [args]
 *
 * @param {(string|symbol)} event - The event name.
 ...
 *
 * @method Phaser.Loader.LoaderPlugin#on
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Loader.LoaderPluginEventsMap} K - [event]
 * @genericUse {Phaser.Types.Loader.LoaderPluginEventsMap[K]} - [fn]
 *
 * @param {(string|symbol)} event - The event name.
 ...
 * Add a listener for a given event.
 *
 * @method Phaser.Loader.LoaderPlugin#addListener
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Loader.LoaderPluginEventsMap} K - [event]
 * @genericUse {Phaser.Types.Loader.LoaderPluginEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.Loader.LoaderPlugin#once
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Loader.LoaderPluginEventsMap} K - [event]
 * @genericUse {Phaser.Types.Loader.LoaderPluginEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.Loader.LoaderPlugin#removeListener
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Loader.LoaderPluginEventsMap} K - [event]
 * @genericUse {Phaser.Types.Loader.LoaderPluginEventsMap[K]} - [fn]
 ...
 * Remove the listeners of a given event.
 *
 * @method Phaser.Loader.LoaderPlugin#off
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Loader.LoaderPluginEventsMap} K - [event]
 * @genericUse {Phaser.Types.Loader.LoaderPluginEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.Loader.LoaderPlugin#removeAllListeners
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Loader.LoaderPluginEventsMap} K - [event]
 *
