 ...
 * @property {Object<string, Function>} [renderNodes] - A map of custom Render Nodes to be added to the WebGL Renderer. The values will be added to the RenderNodeManager, using the keys as the names.
 */
