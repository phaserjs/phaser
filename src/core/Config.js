 ...
 * @property {(Phaser.Scale.Zoom|integer)} [zoom=1] - The zoom value of the game canvas.
 ...
 * @property {Phaser.Scale.ScaleModes} [mode=Phaser.Scale.ScaleModes.NONE] - The scale mode.
 ...
 * @property {Phaser.Scale.Center} [autoCenter=Phaser.Scale.Center.NO_CENTER] - Automatically center the canvas within the parent?
...
var Config = new Class({
    ...
    function Config (config)
    {
        ...
        /**
         * @const {(Phaser.Scale.Zoom|integer)} Phaser.Core.Config#zoom - The zoom factor, as used by the Scale Manager.
         */
        ...
        /**
         * @const {Phaser.Scale.ScaleModes} Phaser.Core.Config#scaleMode - The scale mode as used by the Scale Manager. The default is zero, which is no scaling.
         */
        ...
        /**
         * @const {Phaser.Scale.Center} Phaser.Core.Config#autoCenter - Automatically center the canvas within the parent?
         */
