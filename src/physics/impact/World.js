 ...
 *
 * @method Phaser.Physics.Impact.World#listeners
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Physics.Impact.WorldEventsMap} K - [event]
 *
 ...
 *
 * @method Phaser.Physics.Impact.World#listenerCount
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Physics.Impact.WorldEventsMap} K - [event]
 *
 ...
 *
 * @method Phaser.Physics.Impact.World#emit
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Physics.Impact.WorldEventsMap} K - [event]
 * @genericUse {Phaser.Types.Events.EmitArguments<Phaser.Types.Physics.Impact.WorldEventsMap[K]>} - [args]
 *
 * @param {(string|symbol)} event - The event name.
 ...
 *
 * @method Phaser.Physics.Impact.World#on
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Physics.Impact.WorldEventsMap} K - [event]
 * @genericUse {Phaser.Types.Physics.Impact.WorldEventsMap[K]} - [fn]
 *
 * @param {(string|symbol)} event - The event name.
 ...
 * Add a listener for a given event.
 *
 * @method Phaser.Physics.Impact.World#addListener
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Physics.Impact.WorldEventsMap} K - [event]
 * @genericUse {Phaser.Types.Physics.Impact.WorldEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.Physics.Impact.World#once
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Physics.Impact.WorldEventsMap} K - [event]
 * @genericUse {Phaser.Types.Physics.Impact.WorldEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.Physics.Impact.World#removeListener
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Physics.Impact.WorldEventsMap} K - [event]
 * @genericUse {Phaser.Types.Physics.Impact.WorldEventsMap[K]} - [fn]
 ...
 * Remove the listeners of a given event.
 *
 * @method Phaser.Physics.Impact.World#off
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Physics.Impact.WorldEventsMap} K - [event]
 * @genericUse {Phaser.Types.Physics.Impact.WorldEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.Physics.Impact.World#removeAllListeners
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Physics.Impact.WorldEventsMap} K - [event]
 *
