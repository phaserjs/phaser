 ...
 *
 * @method Phaser.Input.Keyboard.Key#listeners
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Input.Keyboard.KeyEventsMap} K - [event]
 *
 ...
 *
 * @method Phaser.Input.Keyboard.Key#listenerCount
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Input.Keyboard.KeyEventsMap} K - [event]
 *
 ...
 *
 * @method Phaser.Input.Keyboard.Key#emit
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Input.Keyboard.KeyEventsMap} K - [event]
 * @genericUse {Phaser.Types.Events.EmitArguments<Phaser.Types.Input.Keyboard.KeyEventsMap[K]>} - [args]
 *
 * @param {(string|symbol)} event - The event name.
 ...
 *
 * @method Phaser.Input.Keyboard.Key#on
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Input.Keyboard.KeyEventsMap} K - [event]
 * @genericUse {Phaser.Types.Input.Keyboard.KeyEventsMap[K]} - [fn]
 *
 * @param {(string|symbol)} event - The event name.
 ...
 * Add a listener for a given event.
 *
 * @method Phaser.Input.Keyboard.Key#addListener
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Input.Keyboard.KeyEventsMap} K - [event]
 * @genericUse {Phaser.Types.Input.Keyboard.KeyEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.Input.Keyboard.Key#once
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Input.Keyboard.KeyEventsMap} K - [event]
 * @genericUse {Phaser.Types.Input.Keyboard.KeyEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.Input.Keyboard.Key#removeListener
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Input.Keyboard.KeyEventsMap} K - [event]
 * @genericUse {Phaser.Types.Input.Keyboard.KeyEventsMap[K]} - [fn]
 ...
 * Remove the listeners of a given event.
 *
 * @method Phaser.Input.Keyboard.Key#off
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Input.Keyboard.KeyEventsMap} K - [event]
 * @genericUse {Phaser.Types.Input.Keyboard.KeyEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.Input.Keyboard.Key#removeAllListeners
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.Input.Keyboard.KeyEventsMap} K - [event]
 *
