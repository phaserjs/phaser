 ...
 *
 * @method Phaser.GameObjects.LightLayer#renderWebGL
 * @since 3.50.0
 * @private
 *
 * @param {Phaser.Renderer.WebGL.WebGLRenderer} renderer - A reference to the current active WebGL renderer.
 * @param {Phaser.GameObjects.LightLayer} layer - The Game Object being rendered in this call.
 * @param {Phaser.Cameras.Scene2D.Camera} camera - The Camera that is rendering the Game Object.
 */
var LightLayerWebGLRenderer = function (renderer, layer, camera)
{
...
module.exports = LightLayerWebGLRenderer;
