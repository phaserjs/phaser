/**
 * @typedef {object} Phaser.GameObjects.Particles.Types.ParticleEmitterEdgeZoneConfig
 * @since 3.0.0
 *
 * @property {Phaser.GameObjects.Particles.Types.EdgeZoneSource} source - A shape representing the zone. See {@link Phaser.GameObjects.Particles.Zones.EdgeZone#source}.
