 ...
 *
 * @method Phaser.GameObjects.Video#listeners
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.GameObjects.Video.VideoEventsMap} K - [event]
 *
 ...
 *
 * @method Phaser.GameObjects.Video#listenerCount
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.GameObjects.Video.VideoEventsMap} K - [event]
 *
 ...
 *
 * @method Phaser.GameObjects.Video#emit
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.GameObjects.Video.VideoEventsMap} K - [event]
 * @genericUse {Phaser.Types.Events.EmitArguments<Phaser.Types.GameObjects.Video.VideoEventsMap[K]>} - [args]
 *
 * @param {(string|symbol)} event - The event name.
 ...
 *
 * @method Phaser.GameObjects.Video#on
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.GameObjects.Video.VideoEventsMap} K - [event]
 * @genericUse {Phaser.Types.GameObjects.Video.VideoEventsMap[K]} - [fn]
 *
 * @param {(string|symbol)} event - The event name.
 ...
 * Add a listener for a given event.
 *
 * @method Phaser.GameObjects.Video#addListener
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.GameObjects.Video.VideoEventsMap} K - [event]
 * @genericUse {Phaser.Types.GameObjects.Video.VideoEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.GameObjects.Video#once
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.GameObjects.Video.VideoEventsMap} K - [event]
 * @genericUse {Phaser.Types.GameObjects.Video.VideoEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.GameObjects.Video#removeListener
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.GameObjects.Video.VideoEventsMap} K - [event]
 * @genericUse {Phaser.Types.GameObjects.Video.VideoEventsMap[K]} - [fn]
 ...
 * Remove the listeners of a given event.
 *
 * @method Phaser.GameObjects.Video#off
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.GameObjects.Video.VideoEventsMap} K - [event]
 * @genericUse {Phaser.Types.GameObjects.Video.VideoEventsMap[K]} - [fn]
 ...
 *
 * @method Phaser.GameObjects.Video#removeAllListeners
 * @since 3.0.0
 * 
 * @generic {keyof Phaser.Types.GameObjects.Video.VideoEventsMap} K - [event]
 *
