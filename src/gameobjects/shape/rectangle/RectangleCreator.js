...
/**
 * Creates a new Rectangle Game Object and returns it.
 *
 ...
 */
GameObjectCreator.register('rectangle', function (config, addToScene)
{
    ...
    var gameObject = new Rectangle(this.scene, x, y, width, height, fillColor, fillAlpha);
