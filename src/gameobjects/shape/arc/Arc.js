...
var Arc = new Class({
     ...
     * @since 3.13.0
     *
     * @param {integer} angle - The value to set the starting angle to.
     * @param {integer} anticlockwise - The value to set the anticlockwise.
     *
     * @return {this} This Game Object instance.
     */
     ...
     * @since 3.13.0
     *
     * @param {integer} angle - The value to set the ending angle to.
     * @param {integer} anticlockwise - The value to set the anticlockwise.
     *
     * @return {this} This Game Object instance.
     */
