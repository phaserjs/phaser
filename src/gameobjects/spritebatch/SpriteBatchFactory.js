...
Phaser.GameObjects.SpriteBatch.FACTORY_KEY = 'spriteBatch';
...
*
* @method Phaser.GameObjects.Factory#spriteBatch
...
*/
Phaser.GameObjects.SpriteBatch.FACTORY_ADD = function (parent, name, addToStage)
{
    if (parent === undefined) { parent = null; }
    if (name === undefined) { name = 'group'; }
    if (addToStage === undefined) { addToStage = false; }

    return new Phaser.GameObjects.SpriteBatch(this.game, parent, name, addToStage);
};
...
* @return {Phaser.SpriteBatch} The newly created Sprite Batch.
*/
Phaser.GameObjects.SpriteBatch.FACTORY_MAKE = function (parent, name)
{
    if (parent === undefined) { parent = null; }
    if (name === undefined) { name = 'group'; }

    return new Phaser.GameObjects.SpriteBatch(this.game, parent, name);
};
