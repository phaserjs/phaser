...
*
* @class Phaser.GameObjects.SpriteBatch
...
*/
Phaser.GameObjects.SpriteBatch = function (game, parent, name, addToStage) {
...
Phaser.GameObjects.SpriteBatch.prototype = Object.create(Phaser.Group.prototype);

Phaser.GameObjects.SpriteBatch.prototype.constructor = Phaser.GameObjects.SpriteBatch;
