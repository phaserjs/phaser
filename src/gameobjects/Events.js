...
Phaser.Events = function (sprite) {
    ...
    */
    ...
    // setting the values here is to ensure a consistent hidden class independent of
    // when the events are dispatched, but can be omitted without changing the behavior.
    this._onAddedToGroup = null;
    this._onRemovedFromGroup = null;
    this._onRemovedFromWorld = null;
    this._onDestroy = null;
    this._onKilled = null;
    this._onRevived = null;
...
for (var prop in Phaser.Events.prototype)
{
    ...
    Phaser.Events.prototype[dispatch] =
        new Function("'use strict'; "+backing+" && "+backing+".dispatch.apply(this, arguments)");
