 ...
 * @property {number} [z=300] - Z coordinate for the source of the sound.
 ...
 * @property {('linear'|'inverse'|'exponential')} [distanceModel='linear'] - Different algorithms which are used to reduce the volume of the audio source as it moves away from the listener.
 ...
 * @property {number} [rolloffFactor=1] - How quickly does the volume reduce as the panner moves away from the listener.
