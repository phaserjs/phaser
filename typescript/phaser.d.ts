...
declare module Phaser {
    ...
    class Device {
        ...
        static arora: boolean;
        static audioData: boolean;
        static cancelFullScreen: string;
        static canvas: boolean;
        static chrome: boolean;
        static chromeOS: boolean;
        static cocoonJS: boolean;
        static cocoonJSApp: boolean;
        static cordova: boolean;
        static crosswalk: boolean;
        static css3D: boolean;
        static desktop: boolean;
        static deviceReadyAt: number;
        static ejecta: boolean;
        static epiphany: boolean;
        static file: boolean;
        static fileSystem: boolean;
        static firefox: boolean;
        static fullScreen: boolean;
        static fullScreenKeyboard: boolean;
        static getUserMedia: boolean;
        ...
        static m4a: boolean;
        static macOS: boolean;
        static midori: boolean;
        static mobileSafari: boolean;
        static mp3: boolean;
        static mspointer: boolean;
        static node: boolean;
        static nodeWebkit: boolean;
        static ogg: boolean;
        static onInitialized: Phaser.Signal;
        static opera: boolean;
        static opus: boolean;
        static pixelRatio: number;
        static pointerLock: boolean;
        static quirksMode: boolean;
        static requestFullScreen: string;
        static safari: boolean;
        static silk: boolean;
        static support32bit: boolean;
        static touch: boolean;
        static trident: boolean;
        static tridentVersion: number;
        static typedArray: boolean;
        static vibration: boolean;
        static vita: boolean;
        static wav: boolean;
        ...
        static wheelEvent: string;
        static worker: boolean;
