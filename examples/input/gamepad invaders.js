...
function create() {
    ...
    indicator = game.add.sprite(15,45, 'controller-indicator');
    ...
    leftButton = pad1.addButton(Phaser.Gamepad.XBOX360_DPAD_LEFT);
    rightButton = pad1.addButton(Phaser.Gamepad.XBOX360_DPAD_RIGHT);
    fireButton = pad1.addButton(Phaser.Gamepad.XBOX360_A);
}
