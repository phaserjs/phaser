...
(function (Phaser) {
    var Line = (function () {
        ...
        */
        function (output) {
            if (typeof output === "undefined") { output = new Phaser.Line(); }
        ...
        */
        ...
        Object.defineProperty(Line.prototype, "width", {
            get: function () {
                return Phaser.Math.max(this.x1, this.x2) - Phaser.Math.min(this.x1, this.x2);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Line.prototype, "height", {
            get: function () {
                return Phaser.Math.max(this.y1, this.y2) - Phaser.Math.min(this.y1, this.y2);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Line.prototype, "length", {
            ...
            */
            function () {
                return Phaser.Math.sqrt((this.x2 - this.x1) * (this.x2 - this.x1) + (this.y2 - this.y1) * (this.y2 - this.y1));
            },
            enumerable: true,
            configurable: true
        });
        ...
        */
        ...
        Object.defineProperty(Line.prototype, "angle", {
            ...
            */
            function () {
                return Phaser.Math.atan2(this.x2 - this.x1, this.y2 - this.y1);
            },
            enumerable: true,
            configurable: true
        });
        ...
        */
        function (x, y) {
            var xMin = Phaser.Math.min(this.x1, this.x2);
            var xMax = Phaser.Math.max(this.x1, this.x2);
            var yMin = Phaser.Math.min(this.y1, this.y2);
            var yMax = Phaser.Math.max(this.y1, this.y2);
        ...
        function (x, y, output) {
            if(this.y1 === this.y2) {
                if(output) {
                    ...
                    return new Phaser.Line(x, y, x, this.y1);
                }
            }
            ...
            if(output) {
                ...
                return new Phaser.Line(x, y, pt.x, pt.y);
            }
        };
    ...
    var Collision = (function () {
        ...
        */
        function lineToLineSegment(line, seg, output) {
            ...
            if(denominator !== 0) {
                ...
                var maxX = Phaser.Math.max(seg.x1, seg.x2);
                var minX = Phaser.Math.min(seg.x1, seg.x2);
                var maxY = Phaser.Math.max(seg.y1, seg.y2);
                var minY = Phaser.Math.min(seg.y1, seg.y2);
        ...
        */
        function lineToRawSegment(line, x1, y1, x2, y2, output) {
            ...
            if(denominator !== 0) {
                ...
                var maxX = Phaser.Math.max(x1, x2);
                var minX = Phaser.Math.min(x1, x2);
                var maxY = Phaser.Math.max(y1, y2);
                var minY = Phaser.Math.min(y1, y2);
                if((output.x <= maxX && output.x >= minX) === true || (output.y <= maxY && output.y >= minY) === true) {
                    output.result = true;
                }
            }
        ...
        */
        function lineSegmentToLineSegment(line1, line2, output) {
            ...
            if(output.result === true) {
                if(!(output.x >= Phaser.Math.min(line1.x1, line1.x2) && output.x <= Phaser.Math.max(line1.x1, line1.x2) && output.y >= Phaser.Math.min(line1.y1, line1.y2) && output.y <= Phaser.Math.max(line1.y1, line1.y2))) {
                    output.result = false;
                }
            }
            return output;
        ...
        */
        function lineSegmentToRay(line, ray, output) {
            ...
            if(output.result === true) {
                if(!(output.x >= Phaser.Math.min(line.x1, line.x2) && output.x <= Phaser.Math.max(line.x1, line.x2) && output.y >= Phaser.Math.min(line.y1, line.y2) && output.y <= Phaser.Math.max(line.y1, line.y2))) {
                    output.result = false;
                }
            }
            return output;
        ...
        */
        function rectangleToRectangle(rect1, rect2, output) {
            if (typeof output === "undefined") { output = new Phaser.IntersectResult(); }
            var leftX = Phaser.Math.max(rect1.x, rect2.x);
            var rightX = Phaser.Math.min(rect1.right, rect2.right);
            var topY = Phaser.Math.max(rect1.y, rect2.y);
            var bottomY = Phaser.Math.min(rect1.bottom, rect2.bottom);
        ...
        function separateX(object1, object2) {
            ...
            if(overlap != 0) {
                ...
                if(!object1.immovable && !object2.immovable) {
                    ...
                    object2.x += overlap;
                    var obj1NewVelocity = Phaser.Math.sqrt((obj2Velocity * obj2Velocity * object2.mass) / object1.mass) * ((obj2Velocity > 0) ? 1 : -1);
                    var obj2NewVelocity = Phaser.Math.sqrt((obj1Velocity * obj1Velocity * object1.mass) / object2.mass) * ((obj1Velocity > 0) ? 1 : -1);
        ...
        */
        function distance(x1, y1, x2, y2) {
            return Phaser.Math.sqrt((x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1));
        };
        ...
        */
        function isSeparatingAxis(aPos, bPos, aPoints, bPoints, axis, response) {
            ...
            if(response) {
                ...
                var absOverlap = Phaser.Math.abs(overlap);
        ...
        */
        function testCircleCircle(a, b, response) {
            ...
            if(response) {
                var dist = Phaser.Math.sqrt(distanceSq);
                response.a = a;
                response.b = b;
        ...
        function testPolygonCircle(polygon, circle, response) {
            ...
            for(var i = 0; i < len; i++) {
                ...
                if(region === Phaser.Collision.LEFT_VORNOI_REGION) {
                    ...
                    var distAbs = Phaser.Math.abs(dist);
                ...
                if(overlapN && response && Phaser.Math.abs(overlap) < Phaser.Math.abs(response.overlap)) {
...
(function (Phaser) {
    var GameMath = (function () {
        function GameMath(game) {
            ...
            */
            this.globalSeed = Phaser.Math.random();
            this._game = game;
        }
        ...
        GameMath.prototype.fuzzyEqual = function (a, b, epsilon) {
            ...
            return Phaser.Math.abs(a - b) < epsilon;
        };
        ...
        GameMath.prototype.fuzzyCeil = function (val, epsilon) {
            if (typeof epsilon === "undefined") { epsilon = 0.0001; }
            return Phaser.Math.ceil(val - epsilon);
        };
        GameMath.prototype.fuzzyFloor = function (val, epsilon) {
            if (typeof epsilon === "undefined") { epsilon = 0.0001; }
            return Phaser.Math.floor(val + epsilon);
        };
        ...
        GameMath.prototype.slam = function (value, target, epsilon) {
            if (typeof epsilon === "undefined") { epsilon = 0.0001; }
            return (Phaser.Math.abs(value - target) < epsilon) ? target : value;
        };
        ...
        */
        function (n) {
            if(n) {
                return n / Phaser.Math.abs(n);
            } else {
                return 0;
            }
        };
        GameMath.prototype.truncate = function (n) {
            return (n > 0) ? Phaser.Math.floor(n) : Phaser.Math.ceil(n);
        };
        ...
        */
        function (value, max, min) {
            ...
            return value - max * Phaser.Math.floor((value - min) / max);
        };
        ...
        */
        function (input, max, min) {
            if (typeof min === "undefined") { min = 0; }
            return Phaser.Math.max(min, Phaser.Math.min(max, input));
        };
        ...
        */
        function (input, gap, start) {
            ...
            input -= start;
            input = gap * Phaser.Math.round(input / gap);
            return start + input;
        };
        ...
        */
        function (input, gap, start) {
            ...
            input -= start;
            input = gap * Phaser.Math.floor(input / gap);
            return start + input;
        };
        ...
        */
        function (input, gap, start) {
            ...
            input -= start;
            input = gap * Phaser.Math.ceil(input / gap);
            return start + input;
        };
        ...
        */
        function (value, place, base) {
            ...
            var p = Phaser.Math.pow(base, -place);
            return Phaser.Math.round(value * p) / p;
        };
        GameMath.prototype.floorTo = function (value, place, base) {
            if (typeof place === "undefined") { place = 0; }
            if (typeof base === "undefined") { base = 10; }
            var p = Phaser.Math.pow(base, -place);
            return Phaser.Math.floor(value * p) / p;
        };
        GameMath.prototype.ceilTo = function (value, place, base) {
            if (typeof place === "undefined") { place = 0; }
            if (typeof base === "undefined") { base = 10; }
            var p = Phaser.Math.pow(base, -place);
            return Phaser.Math.ceil(value * p) / p;
        };
        ...
        */
        function (angle) {
            return angle * Phaser.GameMath.RAD_TO_DEG;
        };
        GameMath.prototype.degreesToRadians = /**
        * convert degrees to radians
        */
        function (angle) {
            return angle * Phaser.GameMath.DEG_TO_RAD;
        };
        GameMath.prototype.angleBetween = /**
        * Find the angle of a segment from (x1, y1) -> (x2, y2 )
        */
        function (x1, y1, x2, y2) {
            return Phaser.Math.atan2(y2 - y1, x2 - x1);
        };
        ...
        */
        function (angle, radians) {
            ...
            var rd = (radians) ? Phaser.GameMath.PI : 180;
        ...
        */
        function (value, base) {
            return Phaser.Math.log(value) / Phaser.Math.log(base);
        };
        ...
        */
        function (chance) {
            ...
            if(chance <= 0) {
                ...
                if(Phaser.Math.random() * 100 >= chance) {
                    return false;
                } else {
                    return true;
                }
        ...
        */
        function (value, amount, max) {
            var diff;
            value = Phaser.Math.abs(value);
            amount = Phaser.Math.abs(amount);
            max = Phaser.Math.abs(max);
        ...
        */
        function () {
            return (Phaser.Math.random() > 0.5) ? 1 : -1;
        };
        ...
        */
        function (v, k) {
            ...
            var n = v.length - 1;
            for(var i = 0; i <= n; i++) {
                b += Phaser.Math.pow(1 - k, n - i) * Phaser.Math.pow(k, i) * v[i] * this.bernstein(n, i);
            }
            return b;
        };
        ...
        */
        function (objects, startIndex, length) {
            ...
            if(objects != null) {
                ...
                if(l > 0) {
                    return objects[startIndex + Phaser.Math.floor(Phaser.Math.random() * l)];
                }
            }
            return null;
        };
        ...
        */
        function (length, sinAmplitude, cosAmplitude, frequency) {
            ...
            var frq = frequency * Phaser.Math.PI / length;
            this.cosTable = [];
            this.sinTable = [];
        ...
        */
        function (dx, dy) {
            return Phaser.Math.sqrt(dx * dx + dy * dy);
        };
        ...
        */
        function (array) {
            for(var i = array.length - 1; i > 0; i--) {
                var j = Phaser.Math.floor(Phaser.Math.random() * (i + 1));
                var temp = array[i];
                array[i] = array[j];
                array[j] = temp;
            }
        ...
        */
        function (point, x1, y1, angle, asDegrees, distance) {
            ...
            if(distance === null) {
                distance = Phaser.Math.sqrt(((x1 - point.x) * (x1 - point.x)) + ((y1 - point.y) * (y1 - point.y)));
            }
            point.x = x1 + distance * Phaser.Math.cos(angle);
            point.y = y1 + distance * Phaser.Math.sin(angle);
            return point;
        };
        return GameMath;
    })();
        ...
        */
        function (camera, cameraOffsetX, cameraOffsetY) {
            ...
            if(this.type == CollisionMask.QUAD) {
                ...
                this._parent.context.arc(_dx, _dy, this.circle.radius, 0, Phaser.Math.PI * 2);
    ...
    var Motion = (function () {
        ...
        */
        function (angle, speed) {
            ...
            return new Phaser.Point((Phaser.Math.cos(a) * speed), (Phaser.Math.sin(a) * speed));
        };
        ...
        */
        function (source, dest, speed, maxTime) {
            ...
            source.velocity.x = Phaser.Math.cos(a) * speed;
            source.velocity.y = Phaser.Math.sin(a) * speed;
        };
        ...
        */
        function (source, dest, speed, xSpeedMax, ySpeedMax) {
            ...
            source.velocity.x = 0;
            source.velocity.y = 0;
            source.acceleration.x = Phaser.Math.cos(a) * speed;
            source.acceleration.y = Phaser.Math.sin(a) * speed;
        ...
        */
        function (a, target, asDegrees) {
            ...
            if(asDegrees) {
                return this._game.math.radiansToDegrees(Phaser.Math.atan2(dy, dx));
            } else {
                return Phaser.Math.atan2(dy, dx);
            }
        };
...
(function (Phaser) {
    var StageScaleMode = (function () {
        ...
        */
        function () {
            if(this._game.stage.scaleMode !== Phaser.StageScaleMode.NO_SCALE && (window.innerWidth !== this.width || window.innerHeight !== this.height)) {
                this.refresh();
            }
        };
        ...
        */
        function (event) {
            ...
            if(this._game.stage.scaleMode !== Phaser.StageScaleMode.NO_SCALE) {
                this.refresh();
            }
        };
        ...
        */
        function () {
            ...
            if(window.innerHeight > this._startHeight || this._iterations < 0) {
                ...
                if(this._game.stage.scaleMode == Phaser.StageScaleMode.EXACT_FIT) {
                ...
                } else if(this._game.stage.scaleMode == Phaser.StageScaleMode.SHOW_ALL) {
                    var multiplier = Phaser.Math.min((window.innerHeight / this._game.stage.height), (window.innerWidth / this._game.stage.width));
                    this.width = Phaser.Math.round(this._game.stage.width * multiplier);
                    this.height = Phaser.Math.round(this._game.stage.height * multiplier);
    ...
    var BootScreen = (function () {
        ...
        */
        function () {
            ...
            this._color1.r = Phaser.Math.round(this._color1.r);
            this._color1.g = Phaser.Math.round(this._color1.g);
            this._color1.b = Phaser.Math.round(this._color1.b);
            this._color2.r = Phaser.Math.round(this._color2.r);
            this._color2.g = Phaser.Math.round(this._color2.g);
            this._color2.b = Phaser.Math.round(this._color2.b);
        };
        ...
        */
        function () {
            ...
            this._fade.to({
                r: Phaser.Math.random() * 250,
                g: Phaser.Math.random() * 250,
                b: Phaser.Math.random() * 250
...
(function (Phaser) {
    var PauseScreen = (function () {
        ...
        */
        function () {
            this._color.r = Phaser.Math.round(this._color.r);
            this._color.g = Phaser.Math.round(this._color.g);
            this._color.b = Phaser.Math.round(this._color.b);
        };
        ...
        */
        function () {
            ...
            this._game.stage.context.fillRect(0, 0, this._game.stage.width, this._game.stage.height);
            //  Draw a 'play' arrow
            var arrowWidth = Phaser.Math.round(this._game.stage.width / 2);
            var arrowHeight = Phaser.Math.round(this._game.stage.height / 2);
    ...
    var Stage = (function () {
        ...
        */
        ...
        Object.defineProperty(Stage.prototype, "randomX", {
            get: function () {
                return Phaser.Math.round(Phaser.Math.random() * this.bounds.width);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Stage.prototype, "randomY", {
            get: function () {
                return Phaser.Math.round(Phaser.Math.random() * this.bounds.height);
            },
            enumerable: true,
            configurable: true
        });
    ...
    var Time = (function () {
        ...
        */
        function (raf) {
            ...
            ;
            this.msMin = Phaser.Math.min(this.msMin, this.delta);
            this.msMax = Phaser.Math.max(this.msMax, this.delta);
            this.frames++;
            if(this.now > this._timeLastSecond + 1000) {
                this.fps = Phaser.Math.round((this.frames * 1000) / (this.now - this._timeLastSecond));
                this.fpsMin = Phaser.Math.min(this.fpsMin, this.fps);
                this.fpsMax = Phaser.Math.max(this.fpsMax, this.fps);
...
(function (Phaser) {
    var RandomDataGenerator = (function () {
        ...
        */
        function (min, max) {
            return Phaser.Math.floor(this.realInRange(min, max));
        };
        ...
        */
        function (array) {
            return array[~~(Phaser.Math.pow(this.frac, 2) * array.length)];
        };
    ...
    var GeomSprite = (function (_super) {
        ...
        */
        function (camera, cameraOffsetX, cameraOffsetY) {
            ...
            */
            this._dx = Phaser.Math.round(this._dx);
            this._dy = Phaser.Math.round(this._dy);
            this._dw = Phaser.Math.round(this._dw);
            this._dh = Phaser.Math.round(this._dh);
            ...
            if(this.type == Phaser.GeomSprite.CIRCLE) {
                ...
                this.context.arc(this._dx, this._dy, this.circle.radius, 0, Phaser.Math.PI * 2);
        ...
        function (camera, cameraOffsetX, cameraOffsetY) {
            ...
            if(this.angle !== 0 || this.rotationOffset !== 0 || this.flipped == true) {
                ...
                if(this.renderRotation == true && (this.angle !== 0 || this.rotationOffset !== 0)) {
                    this.context.rotate((this.rotationOffset + this.angle) * (Phaser.Math.PI / 180));
                }
                this._dx = -(this._dw / 2);
                this._dy = -(this._dh / 2);
            ...
            this._sx = Phaser.Math.round(this._sx);
            this._sy = Phaser.Math.round(this._sy);
            this._sw = Phaser.Math.round(this._sw);
            this._sh = Phaser.Math.round(this._sh);
            this._dx = Phaser.Math.round(this._dx);
            this._dy = Phaser.Math.round(this._dy);
            this._dw = Phaser.Math.round(this._dw);
            this._dh = Phaser.Math.round(this._dh);
    ...
    var ScrollRegion = (function () {
        ...
        */
        function (context, texture, srcX, srcY, srcW, srcH, destX, destY, destW, destH, offsetX, offsetY) {
            ...
            srcX = Phaser.Math.floor(srcX);
            srcY = Phaser.Math.floor(srcY);
            srcW = Phaser.Math.floor(srcW);
            srcH = Phaser.Math.floor(srcH);
            offsetX = Phaser.Math.floor(offsetX + this._bounds.x);
            offsetY = Phaser.Math.floor(offsetY + this._bounds.y);
            if(srcW > 0 && srcH > 0) {
    ...
    var ScrollZone = (function (_super) {
        ...
        */
        function (camera, cameraOffsetX, cameraOffsetY) {
            ...
            if(this.angle !== 0 || this.flipped == true) {
                ...
                this.context.translate(this._dx + (this._dw / 2), this._dy + (this._dh / 2));
                if(this.angle !== 0) {
                    this.context.rotate(this.angle * (Phaser.Math.PI / 180));
                }
                this._dx = -(this._dw / 2);
                this._dy = -(this._dh / 2);
                if(this.flipped == true) {
        ...
        */
        function (regionWidth, regionHeight) {
            ...
            var tileWidth = Phaser.Math.ceil(this._texture.width / regionWidth) * regionWidth;
            var tileHeight = Phaser.Math.ceil(this._texture.height / regionHeight) * regionHeight;
        ...
        function (parent, width, height) {
            ...
            if(!document.body) {
                ...
                this.rnd = new Phaser.RandomDataGenerator([
                    (Date.now() * Phaser.Math.random()).toString()
                ]);
    ...
    var Rectangle = (function () {
        ...
        **/
        ...
        Object.defineProperty(Rectangle.prototype, "halfWidth", {
            ...
            **/
            function () {
                return Phaser.Math.round(this.width / 2);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Rectangle.prototype, "halfHeight", {
            ...
            **/
            function () {
                return Phaser.Math.round(this.height / 2);
            },
            enumerable: true,
            configurable: true
        });
...
(function (Phaser) {
    var Vec2 = (function () {
        ...
        */
        function () {
            return Phaser.Math.sqrt((this.x * this.x) + (this.y * this.y));
        };
        ...
        */
        function (a) {
            ...
            if(den == 0) {
                ...
                return Phaser.Math.abs(this.dot(a) / den);
            }
        };
        ...
        */
        function (a) {
            return Phaser.Math.atan2(a.x * this.y - a.y * this.x, a.x * this.x + a.y * this.y);
        };
    ...
    var PointUtils = (function () {
        ...
        **/
        function clampX(a, min, max) {
            a.x = Phaser.Math.max(Phaser.Math.min(a.x, max), min);
            return a;
        };
        PointUtils.clampY = /**
        ...
        **/
        function clampY(a, min, max) {
            a.y = Phaser.Math.max(Phaser.Math.min(a.y, max), min);
            return a;
        };
        PointUtils.clone = /**
        ...
        **/
        function distanceBetween(a, b, round) {
            ...
            var dy = a.y - b.y;
            if(round === true) {
                return Phaser.Math.round(Phaser.Math.sqrt(dx * dx + dy * dy));
            } else {
                return Phaser.Math.sqrt(dx * dx + dy * dy);
            }
        };
        ...
        */
        function rotate(a, x, y, angle, asDegrees, distance) {
            ...
            if(distance === null) {
                distance = Phaser.Math.sqrt(((x - a.x) * (x - a.x)) + ((y - a.y) * (y - a.y)));
            }
            return a.setTo(x + distance * Phaser.Math.cos(angle), y + distance * Phaser.Math.sin(angle));
        };
...
(function (Phaser) {
    var Circle = (function () {
        ...
        **/
        function () {
            return 2 * (Phaser.Math.PI * this._radius);
        };
        ...
        Object.defineProperty(Circle.prototype, "area", {
            ...
            **/
            function () {
                if(this._radius > 0) {
                    return Phaser.Math.PI * this._radius * this._radius;
                } else {
                    return 0;
                }
            },
    ...
    var CircleUtils = (function () {
        ...
        **/
        function contains(a, x, y) {
            return (a.radius * a.radius >= Phaser.Collision.distanceSquared(a.x, a.y, x, y));
        };
        ...
        **/
        function containsCircle(a, b) {
            return ((a.radius + b.radius) * (a.radius + b.radius)) >= Phaser.Collision.distanceSquared(a.x, a.y, b.x, b.y);
        };
        ...
        **/
        function circumferencePoint(a, angle, asDegrees, out) {
            ...
            return out.setTo(a.x + a.radius * Phaser.Math.cos(angle), a.y + a.radius * Phaser.Math.sin(angle));
        };
        return CircleUtils;
    })();
    ...
    var RectangleUtils = (function () {
        ...
        **/
        function intersection(a, b, out) {
            ...
            if(RectangleUtils.intersects(a, b)) {
                out.x = Phaser.Math.max(a.x, b.x);
                out.y = Phaser.Math.max(a.y, b.y);
                out.width = Phaser.Math.min(a.right, b.right) - out.x;
                out.height = Phaser.Math.min(a.bottom, b.bottom) - out.y;
            }
            return out;
        };
        ...
        **/
        function union(a, b, out) {
            if (typeof out === "undefined") { out = new Phaser.Rectangle(); }
            return out.setTo(Phaser.Math.min(a.x, b.x), Phaser.Math.min(a.y, b.y), Phaser.Math.max(a.right, b.right), Phaser.Math.max(a.bottom, b.bottom));
        };
    ...
    var Vec2Utils = (function () {
        ...
        */
        function epsilonEquals(a, b, epsilon) {
            return Phaser.Math.abs(a.x - b.x) <= epsilon && Phaser.Math.abs(a.y - b.y) <= epsilon;
        };
        Vec2Utils.distance = /**
        ...
        */
        function distance(a, b) {
            return Phaser.Math.sqrt(Vec2Utils.distanceSq(a, b));
        };
        ...
        */
        function angle(a, b) {
            return Phaser.Math.atan2(a.x * b.y - a.y * b.x, a.x * b.x + a.y * b.y);
        };
        Vec2Utils.angleSq = /**
        ...
        */
        function rotate(a, b, theta, out) {
            ...
            var x = a.x - b.x;
            var y = a.y - b.y;
            return out.setTo(x * Phaser.Math.cos(theta) - y * Phaser.Math.sin(theta) + b.x, x * Phaser.Math.sin(theta) + y * Phaser.Math.cos(theta) + b.y);
        };
        Vec2Utils.clone = /**
        * Clone a 2D vector.
        *
    ...
    (function (Math) {
        var Vec2 = (function () {
            ...
            */
            ...
            Vec2.prototype.mutableSet = //  Same as copyFrom, used by VerletManager
            function (v) {
                this.x = v.x;
                this.y = v.y;
                return this;
            };
            Vec2.prototype.mutableAdd = /**
            * Add another vector to this one.
            *
            ...
            */
            ...
            Vec2.prototype.mutableMultiplyByScalar = /**
            ...
            */
            ...
            Vec2.prototype.mutableDivideByScalar = /**
            * Divide this vector by the given scalar.
            *
            * @param {number} scalar
            * @return {Vector2} This for chaining.
            ...
            */
            ...
            Vec2.prototype.edge = function (v, output) {
                if (typeof output === "undefined") { output = new Vector2(); }
            ...
            */
            ...
            Vec2.prototype.getProjectionMagnitude = function (v) {
                var den = v.dot(v);
                if(den == 0) {
                    return 0;
                } else {
            ...
            Vec2.prototype.direction = function (output) {
                if (typeof output === "undefined") { output = new Vector2(); }
                output.copyFrom(this);
                return this.normalize(output);
            };
            Vec2.prototype.normalRightHand = function (output) {
                if (typeof output === "undefined") { output = this; }
            ...
            */
            ...
            Vec2.prototype.clone = function (output) {
                if (typeof output === "undefined") { output = new Vector2(); }
                return output.setTo(this.x, this.y);
            };
            Vec2.prototype.copyFrom = function (v) {
                this.x = v.x;
                this.y = v.y;
                return this;
            };
    ...
    var Pointer = (function () {
        ...
        */
        function (hideIfUp) {
            ...
            this._game.stage.context.beginPath();
            this._game.stage.context.arc(this.x, this.y, this.circle.radius, 0, Phaser.Math.PI * 2);
            if(this.active) {
    ...
    (function (Easing) {
        var Circular = (function () {
            ...
            Circular.In = function In(k) {
                return 1 - Phaser.Math.sqrt(1 - k * k);
            };
            Circular.Out = function Out(k) {
                return Phaser.Math.sqrt(1 - (--k * k));
            };
            Circular.InOut = function InOut(k) {
                if((k *= 2) < 1) {
                    return -0.5 * (Phaser.Math.sqrt(1 - k * k) - 1);
                }
                return 0.5 * (Phaser.Math.sqrt(1 - (k -= 2) * k) + 1);
            };
            return Circular;
        })();
        ...
        var Elastic = (function () {
            ...
            Elastic.In = function In(k) {
                ...
                if(!a || a < 1) {
                    ...
                    s = p * Phaser.Math.asin(1 / a) / (2 * Phaser.Math.PI);
                }
                return -(a * Phaser.Math.pow(2, 10 * (k -= 1)) * Phaser.Math.sin((k - s) * (2 * Phaser.Math.PI) / p));
            };
            Elastic.Out = function Out(k) {
                ...
                return (a * Phaser.Math.pow(2, -10 * k) * Phaser.Math.sin((k - s) * (2 * Phaser.Math.PI) / p) + 1);
            };
            Elastic.InOut = function InOut(k) {
                ...
                if((k *= 2) < 1) {
                    return -0.5 * (a * Phaser.Math.pow(2, 10 * (k -= 1)) * Phaser.Math.sin((k - s) * (2 * Phaser.Math.PI) / p));
                }
                return a * Phaser.Math.pow(2, -10 * (k -= 1)) * Phaser.Math.sin((k - s) * (2 * Phaser.Math.PI) / p) * 0.5 + 1;
            };
            return Elastic;
        })();
    ...
    (function (Easing) {
        var Exponential = (function () {
            ...
            Exponential.In = function In(k) {
                return k === 0 ? 0 : Phaser.Math.pow(1024, k - 1);
            };
            Exponential.Out = function Out(k) {
                return k === 1 ? 1 : 1 - Phaser.Math.pow(2, -10 * k);
            };
            Exponential.InOut = function InOut(k) {
                ...
                if((k *= 2) < 1) {
                    return 0.5 * Phaser.Math.pow(1024, k - 1);
                }
                return 0.5 * (-Phaser.Math.pow(2, -10 * (k - 1)) + 2);
            };
            return Exponential;
        })();
    ...
    (function (Easing) {
        var Sinusoidal = (function () {
            ...
            Sinusoidal.In = function In(k) {
                return 1 - Phaser.Math.cos(k * Phaser.Math.PI / 2);
            };
            Sinusoidal.Out = function Out(k) {
                return Phaser.Math.sin(k * Phaser.Math.PI / 2);
            };
            Sinusoidal.InOut = function InOut(k) {
                return 0.5 * (1 - Phaser.Math.cos(Phaser.Math.PI * k));
            };
            return Sinusoidal;
        })();
    ...
    var Camera = (function () {
        ...
        */
        function (target, style) {
            if (typeof style === "undefined") { style = Phaser.Camera.STYLE_LOCKON; }
            this._target = target;
            var helper;
            switch(style) {
                case Phaser.Camera.STYLE_PLATFORMER:
                    var w = this.width / 8;
                    var h = this.height / 3;
                    this.deadzone = new Phaser.Rectangle((this.width - w) / 2, (this.height - h) / 2 - h * 0.25, w, h);
                    break;
                case Phaser.Camera.STYLE_TOPDOWN:
                    helper = Phaser.Math.max(this.width, this.height) / 4;
                    this.deadzone = new Phaser.Rectangle((this.width - helper) / 2, (this.height - helper) / 2, helper, helper);
                    break;
                case Phaser.Camera.STYLE_TOPDOWN_TIGHT:
                    helper = Phaser.Math.max(this.width, this.height) / 8;
                    this.deadzone = new Phaser.Rectangle((this.width - helper) / 2, (this.height - helper) / 2, helper, helper);
                    break;
                case Phaser.Camera.STYLE_LOCKON:
                default:
                    this.deadzone = null;
                    break;
            }
        ...
        */
        function (x, y) {
            ...
            this.scroll.x = Phaser.Math.round(x - this.worldView.halfWidth);
            this.scroll.y = Phaser.Math.round(y - this.worldView.halfHeight);
        };
        ...
        */
        function (point) {
            point.x += (point.x > 0) ? 0.0000001 : -0.0000001;
            point.y += (point.y > 0) ? 0.0000001 : -0.0000001;
            this.scroll.x = Phaser.Math.round(point.x - this.worldView.halfWidth);
            this.scroll.y = Phaser.Math.round(point.y - this.worldView.halfHeight);
        };
        ...
        */
        function () {
            ...
            if(this._rotation !== 0) {
                ...
                this._game.stage.context.rotate(this._rotation * (Phaser.Math.PI / 180));
    ...
    var Input = (function () {
        ...
        Object.defineProperty(Input.prototype, "x", {
            ...
            **/
            ...
            set: function (value) {
                this._x = Phaser.Math.round(value);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Input.prototype, "y", {
            ...
            **/
            ...
            set: function (value) {
                this._y = Phaser.Math.round(value);
            },
            enumerable: true,
            configurable: true
        });
    ...
    var AnimationLoader = (function () {
        ...
        */
        function parseSpriteSheet(game, key, frameWidth, frameHeight, frameMax) {
            ...
            var row = Phaser.Math.round(width / frameWidth);
            var column = Phaser.Math.round(height / frameHeight);
        ...
        AnimationLoader.parseXMLData = function parseXMLData(game, xml, format) {
            ...
            for(var i = 0; i < frames.length; i++) {
                ...
                if(frame.frameX.nodeValue != '-0' || frame.frameY.nodeValue != '-0') {
                    newFrame.setTrim(true, frame.width.nodeValue, frame.height.nodeValue, Phaser.Math.abs(frame.frameX.nodeValue), Phaser.Math.abs(frame.frameY.nodeValue), frame.frameWidth.nodeValue, frame.frameHeight.nodeValue);
                }
            }
            return data;
        };
    ...
    var Loader = (function () {
            ...
            switch(file.type) {
                ...
                case 'textureatlas':
                    if(file.atlasURL == null) {
                        ...
                        this._xhr.responseType = "text";
                        if(file.format == Phaser.Loader.TEXTURE_ATLAS_JSON_ARRAY) {
                            this._xhr.onload = function () {
        ...
        */
        function (previousKey, success) {
            this.progress = Phaser.Math.round(this.progress + this._progressChunk);
