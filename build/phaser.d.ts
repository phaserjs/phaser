    ...
    module Physics {
        ...
        module Ninja {
            ...
            class AABB {
                ...
                integrate(): void;
                projAABB_Full(x: number, y: number, obj: Phaser.Physics.Ninja.AABB, t: Phaser.Physics.Ninja.Tile): number;
                projAABB_Half(x: number, y: number, obj: Phaser.Physics.Ninja.AABB, t: Phaser.Physics.Ninja.Tile): number;
                projAABB_45Deg(x: number, y: number, obj: Phaser.Physics.Ninja.AABB, t: Phaser.Physics.Ninja.Tile): number;
                projAABB_22DegS(x: number, y: number, obj: Phaser.Physics.Ninja.AABB, t: Phaser.Physics.Ninja.Tile): number;
                projAABB_22DegB(x: number, y: number, obj: Phaser.Physics.Ninja.AABB, t: Phaser.Physics.Ninja.Tile): number;
                projAABB_67DegS(x: number, y: number, obj: Phaser.Physics.Ninja.AABB, t: Phaser.Physics.Ninja.Tile): number;
                projAABB_67DegB(x: number, y: number, obj: Phaser.Physics.Ninja.AABB, t: Phaser.Physics.Ninja.Tile): number;
                projAABB_Convex(x: number, y: number, obj: Phaser.Physics.Ninja.AABB, t: Phaser.Physics.Ninja.Tile): number;
                projAABB_Concave(x: number, y: number, obj: Phaser.Physics.Ninja.AABB, t: Phaser.Physics.Ninja.Tile): number;
            ...
            class Circle {
                ...
                collideWorldBounds(): void;
                projCircle_Full(x: number, y: number, oH: number, oV: number, obj: Phaser.Physics.Ninja.Circle, t: Phaser.Physics.Ninja.Tile): number;
                projCircle_45Deg(x: number, y: number, oH: number, oV: number, obj: Phaser.Physics.Ninja.Circle, t: Phaser.Physics.Ninja.Tile): number;
                projCircle_Concave(x: number, y: number, oH: number, oV: number, obj: Phaser.Physics.Ninja.Circle, t: Phaser.Physics.Ninja.Tile): number;
                projCircle_Convex(x: number, y: number, oH: number, oV: number, obj: Phaser.Physics.Ninja.Circle, t: Phaser.Physics.Ninja.Tile): number;
                projCircle_Half(x: number, y: number, oH: number, oV: number, obj: Phaser.Physics.Ninja.Circle, t: Phaser.Physics.Ninja.Tile): number;
                projCircle_22DegS(x: number, y: number, oH: number, oV: number, obj: Phaser.Physics.Ninja.Circle, t: Phaser.Physics.Ninja.Tile): number;
                projCircle_45DegB(x: number, y: number, oH: number, oV: number, obj: Phaser.Physics.Ninja.Circle, t: Phaser.Physics.Ninja.Tile): number;
                projCircle_67DegS(x: number, y: number, oH: number, oV: number, obj: Phaser.Physics.Ninja.Circle, t: Phaser.Physics.Ninja.Tile): number;
                projCircle_67DegB(x: number, y: number, oH: number, oV: number, obj: Phaser.Physics.Ninja.Circle, t: Phaser.Physics.Ninja.Tile): number;
                reportCollisionVsWorld(px: number, py: number, dx: number, dy: number, obj: Object): void;
                reportCollisionVsBody(px: number, py: number, dx: number, dy: number, obj: Object): void;
