...
function create ()
{
    ...
    var sprite1 = this.add.sprite(200, 300, 'cube').setTint(colors[0]);
    var sprite2 = this.add.sprite(400, 300, 'cube').setTint(colors[1]);
    var sprite3 = this.add.sprite(600, 300, 'cube').setTint(colors[2]);
