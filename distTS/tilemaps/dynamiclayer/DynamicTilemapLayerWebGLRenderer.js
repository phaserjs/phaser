...
var DynamicTilemapLayerWebGLRenderer = function (renderer, src, interpolationPercentage, camera) {
    ...
    for (var index = 0; index < length; index++) {
        ...
        pipeline.batchTexture(src, texture, texture.width, texture.height, tw + x + tile.pixelX * sx, th + y + tile.pixelY * sy, tile.width * sx, tile.height * sy, 1, 1, tile.rotation, tile.flipX, tile.flipY, scrollFactorX, scrollFactorY, tw, th, frameX, frameY, frameWidth, frameHeight, tint, tint, tint, tint, false, 0, 0, camera, null);
    }
};
module.exports = DynamicTilemapLayerWebGLRenderer;
//# sourceMappingURL=DynamicTilemapLayerWebGLRenderer.js.map